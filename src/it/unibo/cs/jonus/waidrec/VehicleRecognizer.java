 ...
 * 
 */
public class VehicleRecognizer extends VehicleManager {
	...
	private Runnable classificationRunnable = new Runnable() {
		...
		public void run() {
			...
			mModelManager.classifyInstance(instance);
	 ...
	 * @param delay
	 */
	public VehicleRecognizer(Context context, ModelManager modelManager,
			long delay) {
